...
public class AppUrlStore implements Serializable {
	...
	private String telefoneCrudUrl = null;

	public String getBaseUrl() {return baseUrl; }
	public String getSimpleCrudUrl() { return simpleCrudUrl; }
	public String getTelefoneCrudUrl() {return telefoneCrudUrl;}
    ...
    public void init() {
		...
		this.telefoneCrudUrl = baseUrl + "telefonecrud.xhtml";
    }
}
